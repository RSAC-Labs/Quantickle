...
fm.readFileAsText = async () => JSON.stringify({
  nodes: [{ data: { id: 'n1', type: 'threat_actor' } }],
  edges: []
});
...
(async () => {
  ...
  assert.ok(window.NodeTypes.threat_actor, 'Cybersecurity domain should be loaded');
  console.log('file-manager-cybersecurity-autoload.test.js passed');
})();
