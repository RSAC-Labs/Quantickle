...
cy.add([
  { data: { id: 'a', timestamp: '2007-05-07T00:00:00Z' } },
  { data: { id: 'b', timestamp: '2021-05-07T00:00:00Z' } }
]);
...
const lastYear = parseInt(tickLabels[tickLabels.length - 1], 10);
if (lastYear <= 2007) {
  throw new Error('Tick labels did not extend past 2007');
}

console.log('Timeline layout handles ISO 8601 timestamps');
process.exit(0);
