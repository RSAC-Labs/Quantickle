...
cy.add([
  { data: { id: 'a', timestamp: '2024-03-28T00:00:00Z' } },
  { data: { id: 'b', timestamp: '2024-03-30T00:00:00Z' } }
]);
...
if (!labels.includes('3/28') || !labels.includes('3/30')) {
  throw new Error('Daily tick labels incorrect');
}

console.log('Timeline layout uses UTC for daily tick labels');
process.exit(0);
