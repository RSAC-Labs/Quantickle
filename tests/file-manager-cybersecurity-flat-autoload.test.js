...
(async () => {
  ...
  assert.ok(window.NodeTypes.threat_actor, 'Cybersecurity domain should load for flattened nodes');
  console.log('file-manager-cybersecurity-flat-autoload.test.js passed');
})();
